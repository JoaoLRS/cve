# CDU-01: Inicialização da aplicação

## OBS: O sistema sera inicializado atraves do cve.exe (execultavel)

1. Ao iniciar a aplicação o usuario vera as seguintes componentes:

    1.1 - Titulo do sistema: `CVE - Contabilização de vagas de estacionamento`.
